...
# start with models one main effect to test model comparison
mod_divQ[[1]] <- brm(ProbDiv ~ 0 + intercept + stdAgeFemale + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[1]] <-  add_waic(mod_divQ[[1]]) # adds IC info to brms object
plot(mod_divQ[[1]], pars = "^b_")

mod_divQ[[2]] <- brm(ProbDiv ~ 0 + intercept + stdAgeMale + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[2]] <-  add_waic(mod_divQ[[2]])
plot(mod_divQ[[2]], pars = "^b_")

mod_divQ[[3]] <- brm(ProbDiv ~ 0 + intercept + stdExpFemale + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[3]] <-  add_waic(mod_divQ[[3]])
plot(mod_divQ[[3]], pars = "^b_")

mod_divQ[[4]] <- brm(ProbDiv ~ 0 + intercept + stdExpMale + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[4]] <-  add_waic(mod_divQ[[4]])
plot(mod_divQ[[4]], pars = "^b_")

mod_divQ[[5]] <- brm(ProbDiv ~ 0 + intercept + stdPairBond + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[5]] <-  add_waic(mod_divQ[[5]])
plot(mod_divQ[[5]], pars = "^b_")

mod_divQ[[6]] <- brm(ProbDiv ~ 0 + intercept + stdFledge + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[6]] <-  add_waic(mod_divQ[[6]])
plot(mod_divQ[[6]], pars = "^b_")

mod_divQ[[7]] <- brm(ProbDiv ~ 0 + intercept + stdQlty + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[7]] <-  add_waic(mod_divQ[[7]])
plot(mod_divQ[[7]], pars = "^b_")

mod_divQ[[8]] <- brm(ProbDiv ~ 0 + intercept + stdLaying + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[8]] <-  add_waic(mod_divQ[[8]])
plot(mod_divQ[[8]], pars = "^b_")

mod_divQ[[9]] <- brm(ProbDiv ~ 0 + intercept + stdYear + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[9]] <-  add_waic(mod_divQ[[9]])
plot(mod_divQ[[9]], pars = "^b_")

mod_divQ[[10]] <- brm(ProbDiv ~ 0 + intercept + (1|Year) + (1|Site) + (1|BandM) + (1|BandF), family = bernoulli(), data =  TBMU_divorce_cleanQ,  prior = c(set_prior("normal(0,5)", class = "b"), set_prior("student_t(3,0,5)", class = "sd")), warmup = 1000, iter = 10000, thin =5, chains = 4, control = list(adapt_delta = 0.99), cores = getOption("mc.cores", 1L))
mod_divQ[[10]] <-  add_waic(mod_divQ[[10]])
plot(mod_divQ[[10]], pars = "^b_")
```
...
```{r}
loo_model_weights(mod_AgeF,mod_AgeF2, method = "stacking")
```
...
prior = c(set_prior("normal(0,5)", class = "Intercept"), set_prior("normal(0,5)", class = "b"), set_prior("cauchy(0,2)", class = "sd"), set_prior("lkj(2)", class = "cor")),
